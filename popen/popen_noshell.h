...
int popen_noshell2( char *file,  char *  *argv,  struct popen_noshell_pass_to_pclose *pclose_arg, int stderr_mode, int pipe_out);
int popen_noshell3( char *file,  char *  *argv,  struct popen_noshell_pass_to_pclose *pclose_arg, int stderr_mode, int pipe_out);
...
int pclose_noshell2(struct popen_noshell_pass_to_pclose *arg); /* the pclose() equivalent */
