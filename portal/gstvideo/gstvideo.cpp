...
int main(int argc, char *argv[]) {
	...
	char libvisual_jess[] = 	"alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! libvisual_jess ! video/x-raw,width=240,height=400 ! tee name=t ! queue ! videoflip method=1 ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoscale ! video/x-raw,width=240,height=400 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
	char libvisual_infinite[] = "alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! libvisual_infinite ! video/x-raw,width=400,height=240 ! tee name=t ! queue ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoflip method=3 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
	char libvisual_jakdaw[] = 	"alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! libvisual_jakdaw ! video/x-raw,width=400,height=240 ! tee name=t ! queue ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoflip method=3 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
	char libvisual_oinksie[] = 	"alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! libvisual_oinksie ! video/x-raw,width=400,height=240 ! tee name=t ! queue ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoflip method=3 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
	char goom[] = 				"alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! goom ! video/x-raw,width=320,height=240 ! tee name=t ! capssetter caps=video/x-raw,height=200 ! queue ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoflip method=3 ! videoscale ! video/x-raw,width=240,height=400 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
	char goom2k1[] = 			"alsasrc device=hw:1 buffer-time=20000 ! queue max-size-time=50000000 leaky=upstream ! goom2k1 ! video/x-raw,width=240,height=400 ! tee name=t ! queue ! videoflip method=1 ! eglglessink t. ! queue ! videorate ! video/x-raw,framerate=10/1 ! videoscale ! video/x-raw,width=240,height=400 ! jpegenc ! multifilesink location=/var/www/html/tmp/snapshot.jpg";
